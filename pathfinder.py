#######################
# Taken wholesale (along with priorityqueueset) from Eli Bendersky's website 
# (link here: http://eli.thegreenplace.net/2008/12/13/writing-a-game-in-python-with-pygame-part-i/)
#######################
